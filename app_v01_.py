...
a.metric("Simulado 2", df['Porcentagem Simulado 2'].mean().round(2), border=True)
a.metric("Simulado 3", df['Porcentagem Simulado 3'].mean().round(2), border=True)
b.metric("Simulado 4", df['Porcentagem Simulado 4'].mean().round(2), border=True)
